...
(
	...
	(
		...
		'label' => array
		(
			'fields'                  => array('toDate', 'title', 'place', 'country'),
			'showColumns'             => true,
			'format'                  => '%s %s %s %s',
	...
	'palettes' => array
	(
		'default'                     => '{title_legend},title,alias,type;{place_legend},place,country;{date_legend},fromDate,toDate;{options_legend},singleSRC,url;{publish_legend},published'
	),
	...
	(
		...
		'alias' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_chesscompetition']['alias'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array
			...
			'save_callback' => array
			(
				array('tl_chesscompetition', 'generateAlias')
			),
